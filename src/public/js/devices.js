...
export function updateHeatLamp() {
    ...
    const offAbove = parseFloat(document.getElementById('heatLampOffAbove').value);
...
export function updateLights() {
    ...
    const offHour = document.getElementById('lightsOffHour').value.padStart(2, '0');
